...
/******************************************END_OF_DECK_CLASS*************************************************/
	...
	void display_text() throws FileNotFoundException{
            ...
            output.write("<html class=\"UNO GAME OUTPUT MODEL\" lang=\"en-us\">\n" + "<head>\n" + "   <title>UNO GAME MODEL | GAME OUTPUT </title>\n" +
                          ...
                          "<p><img src=\"https://github.com/cinun/first-project/blob/master/header.jpg?raw=true\" alt=\"Workouts\" width=\"800\" height=\"600\" style=\"float:right; margin: 0 0 10px 10px;\" /></p>\n" +                  
                          "<h2> UNO GAME</h2>\n");
            output.write("<html>"); 
            output.write("<head>"); 
            output.write("<title>"); 
